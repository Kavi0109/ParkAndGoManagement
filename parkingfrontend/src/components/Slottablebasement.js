...
export default function Tablebasement(){
...
<center><h2 style={{marginTop:30}}>Welcome to Basement Parking Area<br></br>Introduction<br/></h2></center>
  ...
  <center><h5 class="card-title">Capacity </h5></center>
    <p class="card-text">
     ...
     <br></br>
     We only can accompany <b>150 Regular Customers.</b>
