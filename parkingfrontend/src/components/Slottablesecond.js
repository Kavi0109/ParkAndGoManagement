...
<center><h2 style={{marginTop:30}}>Welcome to Second Floor Parking Area<br></br>Introduction<br/></h2></center>
  ...
  <center><h5 class="card-title">Capacity </h5></center>
    <p class="card-text">
     ...
     <br></br>
     We only can accompany <b>325 Non-Regular Customers.</b>
     
     We can only facilitate limited Non-regular customers in this area. Therefore please be aware of your availability for our system.
     <br></br>
    </p>
  ...
  <center><h5 class="card-title">Reserve My Slot</h5></center>
    <p class="card-text">
     In our parking system uusers must go thrugh with some rules and regulations.
     <br>
     </br><br/>
     Note : Please note that this booking will be availbale only for one month period. And after the month the slot will be available again. 
     <br></br>
     ...
     <b>This area is reserved for only our Non-regular customers. If you are not a regular customer you will be inform and we are requiring you to change your slot. 
     </b><br></br>
    </p>
