...
<br/><br/>
	...
	<div class ="Lcard">
        ...
        <div class="Lcard-text">
				...
				<p>Salary Services, provides the framework for compensation initiatives through competitive benchmarking, salary structure development,anddocumentation. There are three key types of incentives: bonuses, profit sharing and commission options.</p>
...
<br/>
	...
	<div class ="Lcard">
        ...
        <div class="Lcard-text">
				...
				<p>The company privacy policy is to safeguard personal employee salary information in its possession to ensure the confidentiality of the information. Additionally, the company will only collect personal information that is required to pursue its salary operations.</p>
				<button href="Land.html"  class="Btn5">Show more</button>
			</div>
