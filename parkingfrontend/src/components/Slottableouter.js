...
<center><h2 style={{marginTop:30}}>Welcome to Outer Parking Area<br></br>Introduction<br/></h2></center>
  ...
  <center><h5 class="card-title">Capacity </h5></center>
    <p class="card-text">
     ...
     <br></br>
     We only can accompany <b>275 Regular Customers.</b>
  ...
  <center><h5 class="card-title">Reserve My Slot</h5></center>
    <p class="card-text">
     ...
     <b>This area is reserved for only walk in customers. If you are not a regular customer you will be inform and we are requiring you to change your slot. 
     </b><br></br>
    </p>
